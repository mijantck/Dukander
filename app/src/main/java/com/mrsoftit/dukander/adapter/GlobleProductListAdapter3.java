...
public class GlobleProductListAdapter3 extends FirestoreRecyclerAdapter<GlobleProductNote3, GlobleProductListAdapter3.ViewHolde> {
    ...
    public GlobleProductListAdapter3(@NonNull FirestoreRecyclerOptions<GlobleProductNote3> options) {
        super(options);
    }

    @Override
    protected void onBindViewHolder(@NonNull ViewHolde holder, int position, @NonNull GlobleProductNote3 model) {

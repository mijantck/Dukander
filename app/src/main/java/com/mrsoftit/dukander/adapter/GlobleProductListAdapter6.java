...
public class GlobleProductListAdapter6 extends FirestoreRecyclerAdapter<GlobleProductNote6, GlobleProductListAdapter6.ViewHolde> {
    ...
    public GlobleProductListAdapter6(@NonNull FirestoreRecyclerOptions<GlobleProductNote6> options) {
        super(options);
    }

    @Override
    protected void onBindViewHolder(@NonNull ViewHolde holder, int position, @NonNull GlobleProductNote6 model) {
